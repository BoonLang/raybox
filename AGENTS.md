...
- Capture classic UI (700x700):
  `cargo run -p tools -- screenshot --url http://localhost:8000/web/index.html --output classic/screenshots/screenshot.png --width 700 --height 700`
...
- Emergent (3D blocks) capture:
  ...
  Compare to reference: `cargo run -p tools -- pixel-diff --reference reference/screenshots/screenshot.png --current emergent/screenshot.png --threshold 0.97`
