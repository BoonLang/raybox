...
//!
//! Run with: cargo run --example demo_towers --features windowed

#[cfg(not(feature = "windowed"))]
fn main() {
    eprintln!("This example requires the 'windowed' feature.");
    eprintln!("Run with: cargo run --example demo_towers --features windowed");
}
...
#[cfg(feature = "windowed")]
const DEMO_TITLE: &str = "Demo 3: Towers";
        ...
        fn resumed(&mut self, event_loop: &ActiveEventLoop) {
            if self.renderer.is_none() {
                let window_attrs = Window::default_attributes()
                    .with_title(input::demo_title(3, "Towers"))
